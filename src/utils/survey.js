  ...
  data: [
    {
      ...
      answers: ["40% Robot", "Live the rest of your life without technology"]
    },
    {
      question: "On a Friday night out, you can find me ...",
      answers: [
        "Dancing at a Brooklyn night club",
        "A play or performance of some sort",
        "My neighborhood bar",
        "In bed"
      ]
    },
    ...
    {
      question: "Your future midlife crisis would be ...",
      answers: [
    ...
    },
    {
      ...
      answers: [
        ...
        "Gifts",
        "Physical Touch",
        "Can people stop bringing up love languages? Mine changes by the day"
      ]
    },
    {
      question: "Your idea of the perfect pet is ... ",
      answers: [
        "Something loyal, fluffy, and loving",
    ...
    {
      question: "Your view on relationships is ...",
      answers: [
        "They are either meant to be or they’re not",
        "They require constant work and revisiting of joint goals",
        "They save me from having to make awkward conversation at dinner parties"
      ]
    },

    {
      question:
        "If you’ve just been given a one time gift of $10,000, you would ...",
      answers: [
        "Donate it to a noteworthy cause",
        "Save or invest it. Planning for the future is important",
        "Spend it and enjoy; there’s no time like the present"
      ]
    },
    {
      question: "Your idea of the perfect Sunday is ...",
      answers: [
        "Getting up early and checking items off my to do list",
        "Going on an adventure- exploring a new part of town or going on a trip",
    ...
    {
      question: "On the weekdays, your alarm ... ",
      answers: [
        "Is set between 6 and 8am.",
    ...
    {
      question: "The holidays makes you feel ... ",
      answers: [
        "Anxious. There are a lot of people I've been avoiding since the last family gathering",
        "Excited. I can’t wait to see my loved ones",
    ...
    {
      question: "The last time you prayed was ... ",
      answers: [
    ...
    {
      question: "Your perfect partner ...",
      answers: [
        "Is always by my side",
        "Does their own thing, but is there when I need them",
        "Knows how to balance time with me and time with friends",
        "Mostly does their own thing"
      ]
    },
    {
      question: "Your perfect vacation is ...",
      answers: [
        "Something adventurous (i.e., a climbing, skiing, etc.)",
        "Something relaxing (i.e., a beach, or somewhere poolside)",
        "Something educational (i.e., cultural experiences like a language or cooking class)",
    ...
    {
      question: "When it comes to learning, you believe ...",
      answers: [
        "We should constantly seek knowledge, as we are all lifelong learners",
        "We should study whatever we need to help us get ahead",
        "It’s best left in the past with formal schooling"
      ]
    },
    {
      question: "When it comes to money, you and your partner ...",
      answers: [
        "Should split everything down the middle for the duration of our relationship",
        "Should pay for our own expenses and negotiate on joint purchases",
        "Should combine our money and pay from a joint account ",
        "Have decided that the person who earns more will pay for most things"
      ]
    },
    {
      question: "You envision your wedding as ...",
      answers: [
    ...
    {
      question: "When it comes to politics, you are interested in someone ...",
      answers: [
    ...
    {
      question:
        "In 10 years, with regard to your love life, you will most like be ...",
      answers: [
        "Casually dating- there are so many fun people to meet!",
        "Married with children; somewhere with more space",
        "Married with children but still hustling in the city",
        "Married but no kids- enjoying time with my partner",
        "I have no idea"
      ]
    }
  ]
